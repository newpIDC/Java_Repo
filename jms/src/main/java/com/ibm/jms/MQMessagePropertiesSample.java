...
public class MQMessagePropertiesSample {
  ...
  public static final String sccsid = "@(#)  samples/wmqjava/MQMessagePropertiesSample.java, jmscc.samples, k710, k710-002-120928 1.9.2.1 11/10/17 15:54:26"; //$NON-NLS-1$
